...
const deployScaffoldRecipeNFTOnchainContract: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  const mintNFTOnchainContract = await hre.ethers.getContract<Contract>("ScaffoldRecipeNFTOnchain", deployer);
  console.log("🚀 Deploy ScaffoldRecipeNFTOnchain Contract:", await mintNFTOnchainContract.getAddress());
};
