...
const deployHardhatFoundryERC721Contract: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  const hardhatFoundryERC721Contract = await hre.ethers.getContract<Contract>("HardhatFoundryERC721", deployer);
  console.log("🚀 Deploy HardhatFoundryERC721 Contract:", await hardhatFoundryERC721Contract.getAddress());
};
